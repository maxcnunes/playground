...
describe 'Library object' do
  ...
  before :all do
    lib_obj = [
      ...
      Book.new("Javascript Patterns", "Soyan Stefanov", :development),
  ...
  it "returns all the books in a given category" do
    @lib.get_books_in_category(:development).length == 2
  end

  it "accepts new books" do
    @lib.add_book(Book.new("Designing for the Web", "Mark Boulon", :design))
